...
exports.leaveWithdrawalAdminTemplate = exports.getResetPasswordEmailTemplate = exports.getOtpEmailTemplate = exports.leaveStatusUpdateTemplate = exports.leaveAppliedEmployeeTemplate = exports.leaveAppliedAdminTemplate = void 0;
const leaveAppliedAdminTemplate = (employeeName, durationText, startDate, endDate, reason) => `
...
`;
exports.leaveAppliedAdminTemplate = leaveAppliedAdminTemplate;
const leaveAppliedEmployeeTemplate = (employeeName, durationText, startDate, endDate, reason) => `
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
...
`;
exports.leaveAppliedEmployeeTemplate = leaveAppliedEmployeeTemplate;
const leaveStatusUpdateTemplate = (employeeName, startDate, endDate, status, adminNote) => {
...
exports.leaveStatusUpdateTemplate = leaveStatusUpdateTemplate;
...
const getResetPasswordEmailTemplate = (fullName, otp) => {
    return `
    <div style="font-family: Arial, sans-serif; padding: 20px; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #eaeaea; border-radius: 10px;">
...
const leaveWithdrawalAdminTemplate = (employeeName, startDate, endDate, message) => `
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
...
`;
exports.leaveWithdrawalAdminTemplate = leaveWithdrawalAdminTemplate;
